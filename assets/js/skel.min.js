    ...
    var t = {
        ...
        on: function(e, n) {
            ...
            function(e) {
                ...
                if (t.isInit) {
                    ...
                    else if ("!" == r.charAt(0) && !t.obj.breakpoints[r.substring(1)].active) return void n()
                }
        ...
        initMethods: function() {
            ...
            function() {
                ...
                return i.addEventListener(r, e = function() {
            ...
            function(t) {
                ...
                h = f.test(a[l]);
                return a[d] && a[d](c, n = function() {
                    a.removeEventListener(c, n, r),
                    e()
                },
                r),
                s && a.attachEvent(u, n = function() { / ^c / .test(a[l]) && (a.detachEvent(u, n), e())
                }),
                t = s ?
                function(e) {
            ...
            function(t, e) {
                ...
                for (0 > r && (r = i - Math.abs(r)), n = r; i > n; n++) if (this[n] === t) return n;
                return - 1
            },
            ...
            function(t) {
                ...
                return e.styleSheet ? e.styleSheet.cssText = r: e.textContent = r,
                "1px" === i.width
            }: function(t) {
                if ("" == t) return ! 0;
                var e, n, i, r, a = {
                ...
                n = t.split(/\s+and\s+/);
                for (r in n) e = n[r],
                "(" == e.charAt(0) && (e = e.substring(1, e.length - 1), i = e.split(/:\s+/), 2 == i.length && (a[i[0].replace(/^\s+|\s+$/g, "")] = parseInt(i[1]), o = !0));
                if (!o) return ! 1;
                var s = document.documentElement.clientWidth,
                c = document.documentElement.clientHeight;
                return null !== a["min-width"] && s < a["min-width"] || null !== a["max-width"] && s > a["max-width"] || null !== a["min-height"] && c < a["min-height"] || null !== a["max-height"] && c > a["max-height"] ? !1 : !0
            },
        ...
        initVars: function() {
            var e, n, i, r = navigator.userAgent;
            e = "other",
            n = 0,
            ...
            t.iterate(i,
            function(t, i) {
                return r.match(i[1]) ? (e = i[0], n = parseFloat(RegExp.$1), !1) : void 0
            }),
            t.vars.browser = e,
            ...
            t.iterate(i,
            function(t, i) {
                return r.match(i[1]) ? (e = i[0], n = parseFloat(i[2] ? i[2](RegExp.$1) : RegExp.$1), !1) : void 0
            }),
            t.vars.os = e,
            t.vars.osVersion = n,
